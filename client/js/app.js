...
function initSidebar(activePage) {
  ...
  const navItems = [
    ...
    { id: 'jadwal', label: 'Jadwal Penyembelihan', href: '/jadwal.html', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', roles: ['SUPER_ADMIN', 'KETUA_PANITIA', 'PANITIA_VOUCHER'] },
    { id: 'seset', label: 'Cheat Sheet Seset', href: '/seset.html', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', roles: ['SUPER_ADMIN', 'KETUA_PANITIA', 'PANITIA_VOUCHER', 'PANITIA_SCANNER'] },
    { id: 'operasional', label: 'Operasional Hari-H', href: '/operasional.html', icon: 'M13 10V3L4 14h7v7l9-11h-7z', roles: ['SUPER_ADMIN', 'KETUA_PANITIA', 'PANITIA_VOUCHER', 'PANITIA_SCANNER'] },
    { id: 'scanner-animal', label: 'Scan Kartu Hewan', href: '/scanner-animal.html', icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z', roles: ['SUPER_ADMIN', 'KETUA_PANITIA', 'PANITIA_SCANNER'] },
